Pod::Spec.new do |s|
  ...
  s.license             = { :type => 'MIT', :file => 'OnsideKit.xcframework/LICENSE' }
  ...
  s.source              = { :http => 'https://github.com/onside-io/OnsideKit-iOS/releases/download/0.7.4/OnsideKit.xcframework.zip' }
  s.platform            = :ios, '16.0'
