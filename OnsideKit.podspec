Pod::Spec.new do |s|
  ...
  s.source              = { :http => 'https://github.com/onside-io/OnsideKit-iOS/releases/download/1.0.2/OnsideKit.xcframework.zip' }
  s.platform            = :ios, '16.0'
  s.preserve_paths      = 'OnsideKit.xcframework', 'LICENSE'
